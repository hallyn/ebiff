...
#include "notifyer_flite.h"

/*******************************************************************************
 *
 *
 */
void NotifyerFlite::SetString(string name, string value) throw(NotifyerException)
{
if(name == "one")
	one = value;
if(name == "zero")
 ...
 *
 */
void NotifyerFlite::SetBool(string name, bool value) throw(NotifyerException)
{
 ...
 *
 */
void NotifyerFlite::SetNumber(string name, double value) throw(NotifyerException)
{
}

string NotifyerFlite::replace_metas(string s,ReducedMailbox* m)
{
 ...
 *
 */
void NotifyerFlite::Notify(ReducedMailbox* m)
{
long unsigned int n = m->CountNew();
...
void *NotifyerFlite::manager_f(void*x)
{
